		...
		*/
		...
		function contactFormSevenEditPage($post){
			...
			if($arrData){
				...
				$progressemail .= ($arrData['template_progress'])?$arrData['template_progress']:'<h4>Dear Applicant,</h4>
<div style="color:gray;">We start process for your application and you got update immoderately. </div>
<br/>
regards,<br/>
Team';
				$completed 		.= ($arrData['template_completed'])?$arrData['template_completed']:'<h4>Dear Applicant,</h4>
<div style="color:gray;">Your Application successfully complete. </div><br/>
regards,<br/>
Team';

				$rejected 		.= ($arrData['template_rejected'])?$arrData['template_rejected']:'<h4>Dear Applicant,</h4>
